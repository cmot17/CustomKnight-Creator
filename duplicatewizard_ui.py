...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.pushButton.clicked.connect(Dialog.select_main_copy) # type: ignore
        self.pushButton_3.clicked.connect(Dialog.accept) # type: ignore
        self.listWidget.currentItemChanged['QListWidgetItem*','QListWidgetItem*'].connect(Dialog.update_preview) # type: ignore
        self.duplicatesWidget.currentItemChanged['QListWidgetItem*','QListWidgetItem*'].connect(Dialog.update_frames) # type: ignore
        self.pushButton_2.clicked.connect(Dialog.autoreplace_all) # type: ignore
